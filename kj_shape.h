...
kj_def kj_rect2f_t kj_rect2f(f32 x, f32 y, f32 w, f32 h);
kj_def kj_rect2i_t kj_rect2i(i32 x, i32 y, i32 w, i32 h);
kj_def kj_rect2u_t kj_rect2u(u32 x, u32 y, u32 w, u32 h);
...
kj_def kj_rect3f_t kj_rect3f(f32 x, f32 y, f32 z, f32 w, f32 h, f32 d);
kj_def kj_rect3i_t kj_rect3i(i32 x, i32 y, i32 z, i32 w, i32 h, i32 d);
kj_def kj_rect3u_t kj_rect3u(u32 x, u32 y, u32 z, u32 w, u32 h, u32 d);
